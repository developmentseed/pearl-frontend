...
export const projectMachine = createMachine(
  {
    ...
    states: {
      ...
      'Applying checkpoint': {
        ...
        exit: ['hideGlobalLoading', 'setCurrentTimeframe', 'setCurrentMosaic'],
