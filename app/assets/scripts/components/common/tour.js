  ...
  const steps = [
    {
      ...
      content: `Select an area of interest to run the model. Click the pencil icon to start drawing on the map, then click the ✔ to confirm. Areas must be under ${apiLimits.live_inference} km² to retrain models, and under ${apiLimits.max_inference} km² total to run inference.`,
      disableBeacon: true,
      placement: 'right',
