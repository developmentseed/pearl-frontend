...
/**
 * This is a fork of @devseed-ui/modal v3.0.1. The method `onEntered` is exposed
 * to facilitate triggering focus actions.
 *
 ...
 *                   Signature: fn(bag). Bag has the following props:
 *                     {function} close Method to close the modal.
 * @param {function} onEntered <Transition> callback fired immediately after
 *                   the 'enter' or 'appear' classes are removed and the done
 *                   class is added to the DOM node.Overrides the modal footer
 *                   element.
 */
